...
| [Previous: Service Architecture](20-service-architecture.md) | [Return to Architecture Overview](00-overview.md) | [Next: iOS Architecture](32-ios-app-architecture.md) |
| :---- | :----: | ----: |