...
**DISCLAIMER**
This Document refers to the initial service architecture of the EduID Mobile App environment. It has been replaced by a [newer version that complies with OpenID Connect](21-service-architecture-oidc.md).
**DISCLAIMER END**
